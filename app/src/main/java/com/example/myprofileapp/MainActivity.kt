package com.latihan.myprofileapp
...
class MainActivity : AppCompatActivity() {
    ...
    private fun validasiInput() {
        ...
        when{
            ...
            genderInput == "Pilih kelamin" -> Toast.makeText(this,
                "Kelamin harus dipilih", Toast.LENGTH_SHORT).show()
            ...
            alamatInput.isEmpty() -> edtAddress.error = "Alamat tidak boleh kosong"
                ...
                Toast.makeText(this,
                    "Navigasi ke halaman profil diri", Toast.LENGTH_SHORT).show()
